...
export class AntimonyParser extends Parser {
	...
	public static readonly RULE_formula = 13;
	...
	public static readonly ruleNames: string[] = [
		...
		"reactantList", "reactant", "compartmentSpecifier", "formula", "functionCall", 
	...
	public formula(_p?: number): FormulaContext {
		...
		this.enterRecursionRule(_localctx, 26, AntimonyParser.RULE_formula, _p);
		let _la: number;
		try {
			let _alt: number;
			this.enterOuterAlt(_localctx, 1);
			...
			while (_alt !== 2 && _alt !== ATN.INVALID_ALT_NUMBER) {
				if (_alt === 1) {
					...
					case 2:
						...
						this.state = 157;
						_la = this._input.LA(1);
						if (!(_la === AntimonyParser.T__1 || _la === AntimonyParser.T__8)) {
						this._errHandler.recoverInline(this);
						} else {
							if (this._input.LA(1) === Token.EOF) {
								this.matchedEOF = true;
	...
	public functionCall(): FunctionCallContext {
		...
		this.enterRule(_localctx, 28, AntimonyParser.RULE_functionCall);
		let _la: number;
		try {
			this.enterOuterAlt(_localctx, 1);
			{
			...
			this._errHandler.sync(this);
			_la = this._input.LA(1);
			if ((((_la) & ~0x1F) === 0 && ((1 << _la) & ((1 << AntimonyParser.T__2) | (1 << AntimonyParser.T__6) | (1 << AntimonyParser.T__7) | (1 << AntimonyParser.T__10) | (1 << AntimonyParser.T__12) | (1 << AntimonyParser.NAME) | (1 << AntimonyParser.NUMBER))) !== 0)) {
				{
				this.state = 174;
				this.parameterList();
				}
	...
	public parameterList(): ParameterListContext {
		...
		this.enterRule(_localctx, 30, AntimonyParser.RULE_parameterList);
		let _la: number;
		try {
			this.enterOuterAlt(_localctx, 1);
			{
	...
	public variable(_p?: number): VariableContext {
		...
		this.enterRecursionRule(_localctx, 32, AntimonyParser.RULE_variable, _p);
		try {
			let _alt: number;
			this.enterOuterAlt(_localctx, 1);
			{
	...
	public static readonly _serializedATN: string =
		"\x03\uC91D\uCABA\u058D\uAFBA\u4F53\u0607\uEA8B\uC241\x03\x1F\xCC\x04\x02" +
		"\t\x02\x04\x03\t\x03\x04\x04\t\x04\x04\x05\t\x05\x04\x06\t\x06\x04\x07" +
		"\t\x07\x04\b\t\b\x04\t\t\t\x04\n\t\n\x04\v\t\v\x04\f\t\f\x04\r\t\r\x04" +
		"\x0E\t\x0E\x04\x0F\t\x0F\x04\x10\t\x10\x04\x11\t\x11\x04\x12\t\x12\x03" +
		"\x02\x03\x02\x03\x02\x03\x02\x07\x02)\n\x02\f\x02\x0E\x02,\v\x02\x05\x02" +
		".\n\x02\x03\x03\x07\x031\n\x03\f\x03\x0E\x034\v\x03\x03\x04\x03\x04\x05" +
		"\x048\n\x04\x03\x05\x03\x05\x03\x05\x03\x05\x07\x05>\n\x05\f\x05\x0E\x05" +
		"A\v\x05\x05\x05C\n\x05\x03\x06\x03\x06\x03\x07\x03\x07\x05\x07I\n\x07" +
		"\x03\x07\x03\x07\x05\x07M\n\x07\x03\x07\x03\x07\x03\x07\x03\b\x03\b\x03" +
		"\b\x03\b\x07\bV\n\b\f\b\x0E\bY\v\b\x05\b[\n\b\x03\b\x03\b\x03\t\x05\t" +
		"`\n\t\x03\t\x03\t\x03\t\x05\te\n\t\x03\t\x05\th\n\t\x03\n\x03\n\x05\n" +
		"l\n\n\x03\n\x03\n\x03\v\x05\vq\n\v\x03\v\x03\v\x03\v\x03\v\x03\v\x05\v" +
		"x\n\v\x05\vz\n\v\x03\f\x03\f\x03\f\x07\f\x7F\n\f\f\f\x0E\f\x82\v\f\x03" +
		"\r\x05\r\x85\n\r\x03\r\x03\r\x03\x0E\x03\x0E\x03\x0E\x03\x0F\x03\x0F\x03" +
		"\x0F\x03\x0F\x03\x0F\x03\x0F\x03\x0F\x03\x0F\x03\x0F\x03\x0F\x03\x0F\x03" +
		"\x0F\x03\x0F\x03\x0F\x05\x0F\x9A\n\x0F\x03\x0F\x03\x0F\x03\x0F\x03\x0F" +
		"\x03\x0F\x03\x0F\x03\x0F\x03\x0F\x03\x0F\x03\x0F\x03\x0F\x03\x0F\x03\x0F" +
		"\x03\x0F\x07\x0F\xAA\n\x0F\f\x0F\x0E\x0F\xAD\v\x0F\x03\x10\x03\x10\x03" +
		"\x10\x05\x10\xB2\n\x10\x03\x10\x03\x10\x03\x11\x03\x11\x03\x11\x07\x11" +
		"\xB9\n\x11\f\x11\x0E\x11\xBC\v\x11\x03\x12\x03\x12\x03\x12\x03\x12\x05" +
		"\x12\xC2\n\x12\x03\x12\x03\x12\x03\x12\x07\x12\xC7\n\x12\f\x12\x0E\x12" +
		"\xCA\v\x12\x03\x12\x02\x02\x04\x1C\"\x13\x02\x02\x04\x02\x06\x02\b\x02" +
		"\n\x02\f\x02\x0E\x02\x10\x02\x12\x02\x14\x02\x16\x02\x18\x02\x1A\x02\x1C" +
		"\x02\x1E\x02 \x02\"\x02\x02\x05\x04\x02\x03\x03\x1C\x1C\x03\x02\t\n\x04" +
		"\x02\x04\x04\v\v\x02\xDC\x02-\x03\x02\x02\x02\x042\x03\x02\x02\x02\x06" +
		"7\x03\x02\x02\x02\bB\x03\x02\x02\x02\nD\x03\x02\x02\x02\fF\x03\x02\x02" +
		"\x02\x0EQ\x03\x02\x02\x02\x10_\x03\x02\x02\x02\x12i\x03\x02\x02\x02\x14" +
		"y\x03\x02\x02\x02\x16{\x03\x02\x02\x02\x18\x84\x03\x02\x02\x02\x1A\x88" +
		"\x03\x02\x02\x02\x1C\x99\x03\x02\x02\x02\x1E\xAE\x03\x02\x02\x02 \xB5" +
		"\x03\x02\x02\x02\"\xC1\x03\x02\x02\x02$*\x05\x06\x04\x02%&\x05\x04\x03" +
		...
		"\x02\x02-$\x03\x02\x02\x02-.\x03\x02\x02\x02.\x03\x03\x02\x02\x02/1\t" +
		"\x02\x02\x020/\x03\x02\x02\x0214\x03\x02\x02\x0220\x03\x02\x02\x0223\x03" +
		"\x02\x02\x023\x05\x03\x02\x02\x0242\x03\x02\x02\x0258\x05\f\x07\x0268" +
		"\x05\n\x06\x0275\x03\x02\x02\x0276\x03\x02\x02\x028\x07\x03\x02\x02\x02" +
		"9?\x05\n\x06\x02:;\x05\x04\x03\x02;<\x05\n\x06\x02<>\x03\x02\x02\x02=" +
		":\x03\x02\x02\x02>A\x03\x02\x02\x02?=\x03\x02\x02\x02?@\x03\x02\x02\x02" +
		"@C\x03\x02\x02\x02A?\x03\x02\x02\x02B9\x03\x02\x02\x02BC\x03\x02\x02\x02" +
		"C\t\x03\x02\x02\x02DE\x05\x10\t\x02E\v\x03\x02\x02\x02FH\x07\x10\x02\x02" +
		"GI\x07\x04\x02\x02HG\x03\x02\x02\x02HI\x03\x02\x02\x02IJ\x03\x02\x02\x02" +
		"JL\x07\x13\x02\x02KM\x05\x0E\b\x02LK\x03\x02\x02\x02LM\x03\x02\x02\x02" +
		"MN\x03\x02\x02\x02NO\x05\b\x05\x02OP\x07\x11\x02\x02P\r\x03\x02\x02\x02" +
		"QZ\x07\x05\x02\x02RW\x05\"\x12\x02ST\x07\x06\x02\x02TV\x05\"\x12\x02U" +
		...
		"[\\\x03\x02\x02\x02\\]\x07\x07\x02\x02]\x0F\x03\x02\x02\x02^`\x05\x12" +
		"\n\x02_^\x03\x02\x02\x02_`\x03\x02\x02\x02`a\x03\x02\x02\x02ab\x05\x14" +
		"\v\x02bd\x07\x03\x02\x02ce\x05\x1C\x0F\x02dc\x03\x02\x02\x02de\x03\x02" +
		"\x02\x02eg\x03\x02\x02\x02fh\x05\x1A\x0E\x02gf\x03\x02\x02\x02gh\x03\x02" +
		"\x02\x02h\x11\x03\x02\x02\x02ik\x07\x13\x02\x02jl\x05\x1A\x0E\x02kj\x03" +
		"\x02\x02\x02kl\x03\x02\x02\x02lm\x03\x02\x02\x02mn\x07\b\x02\x02n\x13" +
		"\x03\x02\x02\x02oq\x05\x16\f\x02po\x03\x02\x02\x02pq\x03\x02\x02\x02q" +
		"r\x03\x02\x02\x02rs\x07\x17\x02\x02sz\x05\x16\f\x02tu\x05\x16\f\x02uw" +
		"\x07\x17\x02\x02vx\x05\x16\f\x02wv\x03\x02\x02\x02wx\x03\x02\x02\x02x" +
		"z\x03\x02\x02\x02yp\x03\x02\x02\x02yt\x03\x02\x02\x02z\x15\x03\x02\x02" +
		"\x02{\x80\x05\x18\r\x02|}\x07\t\x02\x02}\x7F\x05\x18\r\x02~|\x03\x02\x02" +
		"\x02\x7F\x82\x03\x02\x02\x02\x80~\x03\x02\x02\x02\x80\x81\x03\x02\x02" +
		"\x02\x81\x17\x03\x02\x02\x02\x82\x80\x03\x02\x02\x02\x83\x85\x07\x14\x02" +
		"\x02\x84\x83\x03\x02\x02\x02\x84\x85\x03\x02\x02\x02\x85\x86\x03\x02\x02" +
		"\x02\x86\x87\x05\"\x12\x02\x87\x19\x03\x02\x02\x02\x88\x89\x07\x12\x02" +
		"\x02\x89\x8A\x07\x13\x02\x02\x8A\x1B\x03\x02\x02\x02\x8B\x8C\b\x0F\x01" +
		"\x02\x8C\x8D\x07\r\x02\x02\x8D\x9A\x05\x1C\x0F\v\x8E\x8F\x07\x05\x02\x02" +
		"\x8F\x90\x05\x1C\x0F\x02\x90\x91\x07\x07\x02\x02\x91\x9A\x03\x02\x02\x02" +
		"\x92\x9A\x05\"\x12\x02\x93\x94\x07\n\x02\x02\x94\x9A\x07\x14\x02\x02\x95" +
		"\x96\x07\t\x02\x02\x96\x9A\x07\x14\x02\x02\x97\x9A\x07\x14\x02\x02\x98" +
		"\x9A\x05\x1E\x10\x02\x99\x8B\x03\x02\x02\x02\x99\x8E\x03\x02\x02\x02\x99" +
		"\x92\x03\x02\x02\x02\x99\x93\x03\x02\x02\x02\x99\x95\x03\x02\x02\x02\x99" +
		"\x97\x03\x02\x02\x02\x99\x98\x03\x02\x02\x02\x9A\xAB\x03\x02\x02\x02\x9B" +
		"\x9C\f\x0E\x02\x02\x9C\x9D\t\x03\x02\x02\x9D\xAA\x05\x1C\x0F\x0F\x9E\x9F" +
		"\f\r\x02\x02\x9F\xA0\t\x04\x02\x02\xA0\xAA\x05\x1C\x0F\x0E\xA1\xA2\f\t" +
		"\x02\x02\xA2\xA3\x07\x1B\x02\x02\xA3\xAA\x05\x1C\x0F\n\xA4\xA5\f\b\x02" +
		"\x02\xA5\xA6\x07\x1A\x02\x02\xA6\xAA\x05\x1C\x0F\t\xA7\xA8\f\f\x02\x02" +
		"\xA8\xAA\x07\f\x02\x02\xA9\x9B\x03\x02\x02\x02\xA9\x9E\x03\x02\x02\x02" +
		"\xA9\xA1\x03\x02\x02\x02\xA9\xA4\x03\x02\x02\x02\xA9\xA7\x03\x02\x02\x02" +
		"\xAA\xAD\x03\x02\x02\x02\xAB\xA9\x03\x02\x02\x02\xAB\xAC\x03\x02\x02\x02" +
		"\xAC\x1D\x03\x02\x02\x02\xAD\xAB\x03\x02\x02\x02\xAE\xAF\x07\x13\x02\x02" +
		"\xAF\xB1\x07\x05\x02\x02\xB0\xB2\x05 \x11\x02\xB1\xB0\x03\x02\x02\x02" +
		"\xB1\xB2\x03\x02\x02\x02\xB2\xB3\x03\x02\x02\x02\xB3\xB4\x07\x07\x02\x02" +
		"\xB4\x1F\x03\x02\x02\x02\xB5\xBA\x05\x1C\x0F\x02\xB6\xB7\x07\x06\x02\x02" +
		"\xB7\xB9\x05\x1C\x0F\x02\xB8\xB6\x03\x02\x02\x02\xB9\xBC\x03\x02\x02\x02" +
		"\xBA\xB8\x03\x02\x02\x02\xBA\xBB\x03\x02\x02\x02\xBB!\x03\x02\x02\x02" +
		"\xBC\xBA\x03\x02\x02\x02\xBD\xBE\b\x12\x01\x02\xBE\xC2\x07\x13\x02\x02" +
		"\xBF\xC0\x07\x0F\x02\x02\xC0\xC2\x05\"\x12\x03\xC1\xBD\x03\x02\x02\x02" +
		"\xC1\xBF\x03\x02\x02\x02\xC2\xC8\x03\x02\x02\x02\xC3\xC4\f\x04\x02\x02" +
		"\xC4\xC5\x07\x0E\x02\x02\xC5\xC7\x07\x13\x02\x02\xC6\xC3\x03\x02\x02\x02" +
		"\xC7\xCA\x03\x02\x02\x02\xC8\xC6\x03\x02\x02\x02\xC8\xC9\x03\x02\x02\x02" +
		"\xC9#\x03\x02\x02\x02\xCA\xC8\x03\x02\x02\x02\x1C*-27?BHLWZ_dgkpwy\x80" +
		"\x84\x99\xA9\xAB\xB1\xBA\xC1\xC8";
...
export class StatementContext extends ParserRuleContext {
	public reaction(): ReactionContext {
		return this.getRuleContext(0, ReactionContext);
	}
	constructor(parent: ParserRuleContext | undefined, invokingState: number) {
		super(parent, invokingState);
	}
...
export class ExpContext extends FormulaContext {
	public formula(): FormulaContext {
		return this.getRuleContext(0, FormulaContext);
	}
	constructor(ctx: FormulaContext) {
