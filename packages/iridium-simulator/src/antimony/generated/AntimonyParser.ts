...
export class AntimonyParser extends Parser {
  ...
  public static readonly ruleNames: string[] = [
    ...
    "algebraicRule",
    "rename",
    "conversionFactorLeft",
    "conversionFactorRight",
    "delete",
    "annotation",
    "variableAnnotation",
    "hasAnnotation",
  ...
  public static readonly VOCABULARY: Vocabulary = new VocabularyImpl(
    AntimonyParser._LITERAL_NAMES,
    AntimonyParser._SYMBOLIC_NAMES,
    [],
  );
  ...
  public get ruleNames(): string[] {
    return AntimonyParser.ruleNames;
  }

  // @Override
  public get serializedATN(): string {
    return AntimonyParser._serializedATN;
  }
    ...
    try {
      this.enterOuterAlt(_localctx, 1);
      {
        ...
        if (
          ((_la - 8) & ~0x1f) === 0 &&
          ((1 << (_la - 8)) &
            ((1 << (AntimonyParser.T__7 - 8)) |
              (1 << (AntimonyParser.T__12 - 8)) |
              (1 << (AntimonyParser.MODEL - 8)) |
              (1 << (AntimonyParser.FUNCTION - 8)) |
              (1 << (AntimonyParser.AT - 8)) |
              (1 << (AntimonyParser.UNIT - 8)) |
              (1 << (AntimonyParser.SUBS_ONLY - 8)) |
              (1 << (AntimonyParser.DELETE - 8)) |
              (1 << (AntimonyParser.CONST_MODIFIER - 8)) |
              (1 << (AntimonyParser.DECL_WORD - 8)) |
              (1 << (AntimonyParser.NAME - 8)) |
              (1 << (AntimonyParser.NUMBER - 8)) |
              (1 << (AntimonyParser.ARROW - 8)))) !==
            0
        ) {
          {
            this.state = 94;
  ...
  public statementSeparator(): StatementSeparatorContext {
    let _localctx: StatementSeparatorContext = new StatementSeparatorContext(
      this._ctx,
      this.state,
    );
  ...
  public topLevelStatement(): TopLevelStatementContext {
    let _localctx: TopLevelStatementContext = new TopLevelStatementContext(
      this._ctx,
      this.state,
    );
    ...
    try {
      this.enterOuterAlt(_localctx, 1);
      {
        ...
        do {
          ...
          ((_la & ~0x1f) === 0 &&
            ((1 << _la) &
              ((1 << AntimonyParser.T__0) |
                (1 << AntimonyParser.T__7) |
                (1 << AntimonyParser.T__12) |
                (1 << AntimonyParser.MODEL) |
                (1 << AntimonyParser.AT) |
                (1 << AntimonyParser.UNIT) |
                (1 << AntimonyParser.SUBS_ONLY) |
                (1 << AntimonyParser.DELETE) |
                (1 << AntimonyParser.CONST_MODIFIER) |
                (1 << AntimonyParser.DECL_WORD) |
                (1 << AntimonyParser.NAME) |
                (1 << AntimonyParser.NUMBER))) !==
              0) ||
          _la === AntimonyParser.ARROW ||
  ...
  public exportList(): ExportListContext {
    let _localctx: ExportListContext = new ExportListContext(
      this._ctx,
      this.state,
    );
                ...
                case 1:
                  {
                    _localctx = new PowerContext(
                      new FormulaContext(_parentctx, _parentState),
                    );
                    this.pushNewRecursionContext(
                      _localctx,
                      _startState,
                      AntimonyParser.RULE_formula,
                    );
                    this.state = 207;
                ...
                case 2:
                  {
                    ...
                    if (
                      !(
                        (_la & ~0x1f) === 0 &&
                        ((1 << _la) &
                          ((1 << AntimonyParser.T__1) |
                            (1 << AntimonyParser.T__9) |
                            (1 << AntimonyParser.T__10))) !==
                          0
                      )
                    ) {
                      (_localctx as ProductContext)._op =
                        this._errHandler.recoverInline(this);
                    } else {
                      if (this._input.LA(1) === Token.EOF) {
                        this.matchedEOF = true;
                ...
                case 3:
                  {
                    ...
                    if (
                      !(
                        _la === AntimonyParser.T__6 ||
                        _la === AntimonyParser.T__7
                      )
                    ) {
                      (_localctx as SumContext)._op =
                        this._errHandler.recoverInline(this);
                    } else {
                      if (this._input.LA(1) === Token.EOF) {
                        this.matchedEOF = true;
                ...
                case 4:
                  {
                    ...
                    this.state = 217;
                    (_localctx as CompareContext)._op = this.match(
                      AntimonyParser.COMPARE,
                    );
                    this.state = 218;
                    this.formula(3);
                  }
                ...
                case 5:
                  {
                    ...
                    this.state = 220;
                    (_localctx as LogicalContext)._op = this.match(
                      AntimonyParser.LOGICAL,
                    );
                    this.state = 221;
                    this.formula(2);
                  }
    ...
    try {
      this.enterOuterAlt(_localctx, 1);
      {
        ...
        if (
          (_la & ~0x1f) === 0 &&
          ((1 << _la) &
            ((1 << AntimonyParser.T__2) |
              (1 << AntimonyParser.T__6) |
              (1 << AntimonyParser.T__7) |
              (1 << AntimonyParser.T__8) |
              (1 << AntimonyParser.T__12) |
              (1 << AntimonyParser.NAME) |
              (1 << AntimonyParser.NUMBER))) !==
            0
      ...
      this.enterOuterAlt(_localctx, 1);
      {
        ...
        while (_alt !== 2 && _alt !== ATN.INVALID_ALT_NUMBER) {
          if (_alt === 1) {
            ...
            {
              {
                _localctx = new SubvariableContext(
                  new VariableContext(_parentctx, _parentState),
                );
                this.pushNewRecursionContext(
                  _localctx,
                  _startState,
                  AntimonyParser.RULE_variable,
                );
                this.state = 248;
                if (!this.precpred(this._ctx, 2)) {
                  throw this.createFailedPredicateException(
  ...
  public inCompartment(): InCompartmentContext {
    let _localctx: InCompartmentContext = new InCompartmentContext(
      this._ctx,
      this.state,
    );
  ...
  public nameLabel(): NameLabelContext {
    let _localctx: NameLabelContext = new NameLabelContext(
      this._ctx,
      this.state,
    );
  ...
  public reactionFormula(): ReactionFormulaContext {
    let _localctx: ReactionFormulaContext = new ReactionFormulaContext(
      this._ctx,
      this.state,
    );
  ...
  public reactantList(): ReactantListContext {
    let _localctx: ReactantListContext = new ReactantListContext(
      this._ctx,
      this.state,
    );
  ...
  public stoichiometry(): StoichiometryContext {
    let _localctx: StoichiometryContext = new StoichiometryContext(
      this._ctx,
      this.state,
    );
        ...
        if (_la === AntimonyParser.T__13 || _la === AntimonyParser.T__14) {
          {
            ...
            _la = this._input.LA(1);
            if (
              !(_la === AntimonyParser.T__13 || _la === AntimonyParser.T__14)
            ) {
  ...
  public declarationHead(): DeclarationHeadContext {
    let _localctx: DeclarationHeadContext = new DeclarationHeadContext(
      this._ctx,
      this.state,
    );
  ...
  public declarationTerm(): DeclarationTermContext {
    let _localctx: DeclarationTermContext = new DeclarationTermContext(
      this._ctx,
      this.state,
    );
  ...
  public eventOptions(): EventOptionsContext {
    let _localctx: EventOptionsContext = new EventOptionsContext(
      this._ctx,
      this.state,
    );
  ...
  public eventOption(): EventOptionContext {
    let _localctx: EventOptionContext = new EventOptionContext(
      this._ctx,
      this.state,
    );
  ...
  public eventAssignments(): EventAssignmentsContext {
    let _localctx: EventAssignmentsContext = new EventAssignmentsContext(
      this._ctx,
      this.state,
    );
  ...
  public eventAssignment(): EventAssignmentContext {
    let _localctx: EventAssignmentContext = new EventAssignmentContext(
      this._ctx,
      this.state,
    );
  ...
  public algebraicRule(): AlgebraicRuleContext {
    let _localctx: AlgebraicRuleContext = new AlgebraicRuleContext(
      this._ctx,
      this.state,
    );
  ...
  public conversionFactorLeft(): ConversionFactorLeftContext {
    let _localctx: ConversionFactorLeftContext =
      new ConversionFactorLeftContext(this._ctx, this.state);
  ...
  public conversionFactorRight(): ConversionFactorRightContext {
    let _localctx: ConversionFactorRightContext =
      new ConversionFactorRightContext(this._ctx, this.state);
  ...
  public variableAnnotation(): VariableAnnotationContext {
    let _localctx: VariableAnnotationContext = new VariableAnnotationContext(
      this._ctx,
      this.state,
    );
  ...
  public hasAnnotation(): HasAnnotationContext {
    let _localctx: HasAnnotationContext = new HasAnnotationContext(
      this._ctx,
      this.state,
    );
  ...
  public modelAnnotation(): ModelAnnotationContext {
    let _localctx: ModelAnnotationContext = new ModelAnnotationContext(
      this._ctx,
      this.state,
    );
  ...
  public annotationBody(): AnnotationBodyContext {
    let _localctx: AnnotationBodyContext = new AnnotationBodyContext(
      this._ctx,
      this.state,
    );
  ...
  public annotationItem(): AnnotationItemContext {
    let _localctx: AnnotationItemContext = new AnnotationItemContext(
      this._ctx,
      this.state,
    );
  ...
  public string(): StringContext {
    ...
    try {
      this.enterOuterAlt(_localctx, 1);
      {
        ...
        _la = this._input.LA(1);
        if (
          !(_la === AntimonyParser.STRING || _la === AntimonyParser.LONG_STRING)
        ) {
          this._errHandler.recoverInline(this);
        } else {
          if (this._input.LA(1) === Token.EOF) {
  ...
  public unitDeclaration(): UnitDeclarationContext {
    let _localctx: UnitDeclarationContext = new UnitDeclarationContext(
      this._ctx,
      this.state,
    );
  ...
  public unitFormula(_p?: number): UnitFormulaContext {
    ...
    let _parentctx: ParserRuleContext = this._ctx;
    let _parentState: number = this.state;
    let _localctx: UnitFormulaContext = new UnitFormulaContext(
      this._ctx,
      _parentState,
    );
          ...
          case AntimonyParser.NUMBER:
            {
              ...
              this._errHandler.sync(this);
              switch (
                this.interpreter.adaptivePredict(this._input, 66, this._ctx)
              ) {
                case 1:
                  {
                    this.state = 499;
                    (_localctx as UnitNumberContext)._unit = this.match(
                      AntimonyParser.NAME,
                    );
                  }
                  break;
          ...
          if (_alt === 1) {
            ...
            _prevctx = _localctx;
            {
              ...
              switch (
                ...
                case 1:
                  {
                    _localctx = new UnitPowerContext(
                      new UnitFormulaContext(_parentctx, _parentState),
                    );
                    this.pushNewRecursionContext(
                      _localctx,
                      _startState,
                      AntimonyParser.RULE_unitFormula,
                    );
                    this.state = 510;
                    if (!this.precpred(this._ctx, 3)) {
                      throw this.createFailedPredicateException(
                ...
                case 2:
                  {
                    _localctx = new UnitProductContext(
                      new UnitFormulaContext(_parentctx, _parentState),
                    );
                    this.pushNewRecursionContext(
                      _localctx,
                    ...
                    if (
                      ...
                      (_localctx as UnitProductContext)._op =
                        this._errHandler.recoverInline(this);
                    } else {
                      if (this._input.LA(1) === Token.EOF) {
                        this.matchedEOF = true;
                ...
                case 3:
                  {
                    ...
                    if (
                      ...
                      (_localctx as UnitSumContext)._op =
                        this._errHandler.recoverInline(this);
                    } else {
                      if (this._input.LA(1) === Token.EOF) {
                        this.matchedEOF = true;
  ...
  public inStatement(): InStatementContext {
    let _localctx: InStatementContext = new InStatementContext(
      this._ctx,
      this.state,
    );
  ...
  public modelImport(): ModelImportContext {
    let _localctx: ModelImportContext = new ModelImportContext(
      this._ctx,
      this.state,
    );
  ...
  public modelImportOption(): ModelImportOptionContext {
    let _localctx: ModelImportOptionContext = new ModelImportOptionContext(
      this._ctx,
      this.state,
    );
  ...
  public modelImportValue(): ModelImportValueContext {
    let _localctx: ModelImportValueContext = new ModelImportValueContext(
      this._ctx,
      this.state,
    );
  ...
  public sempred(
    ...
    switch (ruleIndex) {
      ...
      case 42:
        return this.unitFormula_sempred(
          _localctx as UnitFormulaContext,
          predIndex,
        );
    }
    return true;
  }
  private formula_sempred(
    _localctx: FormulaContext,
    predIndex: number,
  ): boolean {
    switch (predIndex) {
      case 0:
  ...
  private unitFormula_sempred(
    _localctx: UnitFormulaContext,
    predIndex: number,
  ): boolean {
    switch (predIndex) {
      case 6:
  ...
  private static readonly _serializedATNSegment0: string =
    ...
    "0\x030\x050\u0224\n0\x030\x02\x02\x05\x14\x1AV1\x02\x02\x04\x02\x06\x02" +
    "\b\x02\n\x02\f\x02\x0E\x02\x10\x02\x12\x02\x14\x02\x16\x02\x18\x02\x1A" +
    '\x02\x1C\x02\x1E\x02 \x02"\x02$\x02&\x02(\x02*\x02,\x02.\x020\x022\x02' +
    "4\x026\x028\x02:\x02<\x02>\x02@\x02B\x02D\x02F\x02H\x02J\x02L\x02N\x02" +
    "P\x02R\x02T\x02V\x02X\x02Z\x02\\\x02^\x02\x02\x07\x04\x02\x03\x03))\x04" +
    "\x02\x04\x04\f\r\x03\x02\t\n\x03\x02\x10\x11\x03\x02\'(\x02\u025A\x02" +
    "a\x03\x02\x02\x02\x04n\x03\x02\x02\x02\x06s\x03\x02\x02\x02\by\x03\x02" +
    "\x02\x02\n\x88\x03\x02\x02\x02\f\x8A\x03\x02\x02\x02\x0E\x95\x03\x02\x02" +
    "\x02\x10\xA2\x03\x02\x02\x02\x12\xB4\x03\x02\x02\x02\x14\xCF\x03\x02\x02" +
    "\x02\x16\xE5\x03\x02\x02\x02\x18\xEC\x03\x02\x02\x02\x1A\xF8\x03\x02\x02" +
    "\x02\x1C\u0102\x03\x02\x02\x02\x1E\u0105\x03\x02\x02\x02 \u0113\x03\x02" +
    '\x02\x02"\u011E\x03\x02\x02\x02$\u0124\x03\x02\x02\x02&\u012D\x03\x02' +
    "\x02\x02(\u0136\x03\x02\x02\x02*\u0138\x03\x02\x02\x02,\u0143\x03\x02" +
    "\x02\x02.\u015A\x03\x02\x02\x020\u0161\x03\x02\x02\x022\u017D\x03\x02" +
    "\x02\x024\u0181\x03\x02\x02\x026\u0185\x03\x02\x02\x028\u018C\x03\x02" +
    "\x02\x02:\u019D\x03\x02\x02\x02<\u01A3\x03\x02\x02\x02>\u01B7\x03\x02" +
    "\x02\x02@\u01B9\x03\x02\x02\x02B\u01BC\x03\x02\x02\x02D\u01BF\x03\x02" +
    "\x02\x02F\u01C5\x03\x02\x02\x02H\u01C7\x03\x02\x02\x02J\u01CA\x03\x02" +
    "\u01FF\x05R*\x02\u01FA\u01FB\x07\t\x02\x02\u01FB\u01FF\x05V,\x07\u01FC" +
    "\u01FD\x07\n\x02\x02\u01FD\u01FF\x05V,\x06\u01FE\u01EF\x03\x02\x02\x02" +
    "\u01FE\u01F4\x03\x02\x02\x02\u01FE\u01F8\x03\x02\x02\x02\u01FE\u01F9\x03" +
    "\x02\x02\x02\u01FE\u01FA\x03\x02\x02\x02\u01FE\u01FC\x03\x02\x02\x02\u01FF" +
    "\u020B\x03\x02\x02\x02\u0200\u0201\f\x05\x02\x02\u0201\u0202\x07\b\x02" +
    "\x02\u0202\u020A\x05V,\x05\u0203\u0204\f\x04\x02\x02\u0204\u0205\t\x03" +
    "\x02\x02\u0205\u020A\x05V,\x05\u0206\u0207\f\x03\x02\x02\u0207\u0208\t" +
    "\x04\x02\x02\u0208\u020A\x05V,\x04\u0209\u0200\x03\x02\x02\x02\u0209\u0203" +
    "\x03\x02\x02\x02\u0209\u0206\x03\x02\x02\x02\u020A\u020D\x03\x02\x02\x02" +
    "\u020B\u0209\x03\x02\x02\x02\u020B\u020C\x03\x02\x02\x02\u020CW\x03\x02" +
    "\x02\x02\u020D\u020B\x03\x02\x02\x02\u020E\u020F\x05\x1A\x0E\x02\u020F" +
    "\u0210\x05\x1C\x0F\x02\u0210Y\x03\x02\x02\x02\u0211\u0213\x05\x1E\x10" +
    "\x02\u0212\u0211\x03\x02\x02\x02\u0212\u0213\x03\x02\x02\x02\u0213\u0214" +
    "\x03\x02\x02\x02\u0214\u0215\x07 \x02\x02\u0215\u021A\x05\x0E\b\x02\u0216" +
    "\u0217\x07\x06\x02\x02\u0217\u0219\x05\\/\x02\u0218\u0216\x03\x02\x02" +
    "\x02\u0219\u021C\x03\x02\x02\x02\u021A\u0218\x03\x02\x02\x02\u021A\u021B" +
    "\x03\x02\x02\x02\u021B[\x03\x02\x02\x02\u021C\u021A\x03\x02\x02\x02\u021D" +
    "\u021E\x07 \x02\x02\u021E\u021F\x07\x12\x02\x02\u021F\u0220\x05^0\x02" +
    "\u0220]\x03\x02\x02\x02\u0221\u0224\x05\x1A\x0E\x02\u0222\u0224\x07!\x02" +
    "\x02\u0223\u0221\x03\x02\x02\x02\u0223\u0222\x03\x02\x02\x02\u0224_\x03" +
    "\x02\x02\x02Kaeisv{\x88\x8C\x90\x9B\x9E\xA8\xAF\xBA\xBD\xCF\xE0\xE2\xE8" +
    "\xF1\xF8\xFF\u010A\u010E\u0113\u0118\u011B\u011E\u0122\u0129\u012D\u0132" +
    "\u0136\u013A\u013D\u0141\u0149\u014E\u0153\u0156\u015A\u015F\u0161\u0164" +
    "\u0169\u016D\u0170\u0177\u017B\u017D\u0183\u018C\u0194\u019A\u01A0\u01A3" +
    "\u01A8\u01AC\u01B5\u01B7\u01C5\u01D0\u01D8\u01DD\u01E5\u01ED\u01F6\u01FE" +
    "\u0209\u020B\u0212\u021A";
  private static readonly _serializedATNSegment1: string = "\u0223";
  ...
  public static get _ATN(): ATN {
    if (!AntimonyParser.__ATN) {
      AntimonyParser.__ATN = new ATNDeserializer().deserialize(
        Utils.toCharArray(AntimonyParser._serializedATN),
      );
    }
...
export class RootContext extends ParserRuleContext {
  public EOF(): TerminalNode {
    return this.getToken(AntimonyParser.EOF, 0);
  }
  public topLevelStatement(): TopLevelStatementContext[];
  public topLevelStatement(i: number): TopLevelStatementContext;
  public topLevelStatement(
    i?: number,
  ): TopLevelStatementContext | TopLevelStatementContext[] {
    if (i === undefined) {
  ...
  public statementSeparator(
    i?: number,
  ): StatementSeparatorContext | StatementSeparatorContext[] {
    if (i === undefined) {
  ...
  public get ruleIndex(): number {
    return AntimonyParser.RULE_root;
  }
  // @Override
...
export class StatementSeparatorContext extends ParserRuleContext {
  public NEWLINE(): TerminalNode {
    return this.getToken(AntimonyParser.NEWLINE, 0);
  }
  constructor(parent: ParserRuleContext | undefined, invokingState: number) {
    super(parent, invokingState);
  }
  // @Override
  public get ruleIndex(): number {
    return AntimonyParser.RULE_statementSeparator;
  }
  // @Override
  public enterRule(listener: AntimonyListener): void {
...
export class TopLevelStatementContext extends ParserRuleContext {
  ...
  // @Override
  public get ruleIndex(): number {
    return AntimonyParser.RULE_topLevelStatement;
  }
  // @Override
  public enterRule(listener: AntimonyListener): void {
...
export class StatementListContext extends ParserRuleContext {
  ...
  // @Override
  public get ruleIndex(): number {
    return AntimonyParser.RULE_statementList;
  }
  // @Override
  public enterRule(listener: AntimonyListener): void {
...
export class StatementContext extends ParserRuleContext {
  ...
  // @Override
  public get ruleIndex(): number {
    return AntimonyParser.RULE_statement;
  }
  // @Override
  public enterRule(listener: AntimonyListener): void {
...
export class ModelContext extends ParserRuleContext {
  ...
  public MODEL(): TerminalNode {
    return this.getToken(AntimonyParser.MODEL, 0);
  }
  public NAME(): TerminalNode {
    return this.getToken(AntimonyParser.NAME, 0);
  }
  public statementList(): StatementListContext {
    return this.getRuleContext(0, StatementListContext);
  }
  public END(): TerminalNode {
    return this.getToken(AntimonyParser.END, 0);
  }
  ...
  // @Override
  public get ruleIndex(): number {
    return AntimonyParser.RULE_model;
  }
  // @Override
  public enterRule(listener: AntimonyListener): void {
...
export class ExportListContext extends ParserRuleContext {
  ...
  // @Override
  public get ruleIndex(): number {
    return AntimonyParser.RULE_exportList;
  }
  // @Override
  public enterRule(listener: AntimonyListener): void {
...
export class FunctionDefinitionContext extends ParserRuleContext {
  public FUNCTION(): TerminalNode {
    return this.getToken(AntimonyParser.FUNCTION, 0);
  }
  public NAME(): TerminalNode {
    return this.getToken(AntimonyParser.NAME, 0);
  }
  ...
  // @Override
  public get ruleIndex(): number {
    return AntimonyParser.RULE_functionDefinition;
  }
  // @Override
  public enterRule(listener: AntimonyListener): void {
...
export class ParameterListContext extends ParserRuleContext {
  ...
  // @Override
  public get ruleIndex(): number {
    return AntimonyParser.RULE_parameterList;
  }
  // @Override
  public enterRule(listener: AntimonyListener): void {
...
export class FormulaContext extends ParserRuleContext {
  ...
  // @Override
  public get ruleIndex(): number {
    return AntimonyParser.RULE_formula;
  }
...
export class NumberContext extends FormulaContext {
  public NUMBER(): TerminalNode {
    return this.getToken(AntimonyParser.NUMBER, 0);
  }
  constructor(ctx: FormulaContext) {
    super(ctx.parent, ctx.invokingState);
    this.copyFrom(ctx);
...
export class CompareContext extends FormulaContext {
  ...
  public COMPARE(): TerminalNode {
    return this.getToken(AntimonyParser.COMPARE, 0);
  }
  constructor(ctx: FormulaContext) {
    super(ctx.parent, ctx.invokingState);
    this.copyFrom(ctx);
...
export class LogicalContext extends FormulaContext {
  ...
  public LOGICAL(): TerminalNode {
    return this.getToken(AntimonyParser.LOGICAL, 0);
  }
  constructor(ctx: FormulaContext) {
    super(ctx.parent, ctx.invokingState);
    this.copyFrom(ctx);
...
export class FunctionCallContext extends ParserRuleContext {
  ...
  // @Override
  public get ruleIndex(): number {
    return AntimonyParser.RULE_functionCall;
  }
  // @Override
  public enterRule(listener: AntimonyListener): void {
...
export class ArgumentListContext extends ParserRuleContext {
  ...
  // @Override
  public get ruleIndex(): number {
    return AntimonyParser.RULE_argumentList;
  }
  // @Override
  public enterRule(listener: AntimonyListener): void {
...
export class VariableContext extends ParserRuleContext {
  ...
  // @Override
  public get ruleIndex(): number {
    return AntimonyParser.RULE_variable;
  }
...
export class InCompartmentContext extends ParserRuleContext {
  public IN(): TerminalNode {
    return this.getToken(AntimonyParser.IN, 0);
  }
  public variable(): VariableContext {
    return this.getRuleContext(0, VariableContext);
  }
  ...
  // @Override
  public get ruleIndex(): number {
    return AntimonyParser.RULE_inCompartment;
  }
  // @Override
  public enterRule(listener: AntimonyListener): void {
...
export class NameLabelContext extends ParserRuleContext {
  ...
  // @Override
  public get ruleIndex(): number {
    return AntimonyParser.RULE_nameLabel;
  }
  // @Override
  public enterRule(listener: AntimonyListener): void {
...
export class ReactionContext extends ParserRuleContext {
  ...
  // @Override
  public get ruleIndex(): number {
    return AntimonyParser.RULE_reaction;
  }
  // @Override
  public enterRule(listener: AntimonyListener): void {
...
export class ReactionFormulaContext extends ParserRuleContext {
  ...
  public ARROW(): TerminalNode {
    return this.getToken(AntimonyParser.ARROW, 0);
  }
  public reactantList(): ReactantListContext[];
  ...
  // @Override
  public get ruleIndex(): number {
    return AntimonyParser.RULE_reactionFormula;
  }
  // @Override
  public enterRule(listener: AntimonyListener): void {
...
export class ReactantListContext extends ParserRuleContext {
  ...
  // @Override
  public get ruleIndex(): number {
    return AntimonyParser.RULE_reactantList;
  }
  // @Override
  public enterRule(listener: AntimonyListener): void {
...
export class ReactantContext extends ParserRuleContext {
  ...
  // @Override
  public get ruleIndex(): number {
    return AntimonyParser.RULE_reactant;
  }
  // @Override
  public enterRule(listener: AntimonyListener): void {
...
export class StoichiometryContext extends ParserRuleContext {
  public NUMBER(): TerminalNode | undefined {
    return this.tryGetToken(AntimonyParser.NUMBER, 0);
  }
  ...
  // @Override
  public get ruleIndex(): number {
    return AntimonyParser.RULE_stoichiometry;
  }
  // @Override
  public enterRule(listener: AntimonyListener): void {
...
export class AssignmentContext extends ParserRuleContext {
  ...
  // @Override
  public get ruleIndex(): number {
    return AntimonyParser.RULE_assignment;
  }
  // @Override
  public enterRule(listener: AntimonyListener): void {
...
export class DeclarationContext extends ParserRuleContext {
  ...
  public declarationTerm(
    i?: number,
  ): DeclarationTermContext | DeclarationTermContext[] {
    if (i === undefined) {
  ...
  // @Override
  public get ruleIndex(): number {
    return AntimonyParser.RULE_declaration;
  }
  // @Override
  public enterRule(listener: AntimonyListener): void {
...
export class DeclarationHeadContext extends ParserRuleContext {
  public CONST_MODIFIER(): TerminalNode | undefined {
    return this.tryGetToken(AntimonyParser.CONST_MODIFIER, 0);
  }
  public DECL_WORD(): TerminalNode | undefined {
    return this.tryGetToken(AntimonyParser.DECL_WORD, 0);
  }
  public SUBS_ONLY(): TerminalNode | undefined {
    return this.tryGetToken(AntimonyParser.SUBS_ONLY, 0);
  }
  constructor(parent: ParserRuleContext | undefined, invokingState: number) {
    super(parent, invokingState);
  }
  // @Override
  public get ruleIndex(): number {
    return AntimonyParser.RULE_declarationHead;
  }
  // @Override
  public enterRule(listener: AntimonyListener): void {
...
export class DeclarationTermContext extends ParserRuleContext {
  ...
  // @Override
  public get ruleIndex(): number {
    return AntimonyParser.RULE_declarationTerm;
  }
...
export class EventContext extends ParserRuleContext {
  ...
  public AT(): TerminalNode {
    return this.getToken(AntimonyParser.AT, 0);
  }
  public formula(): FormulaContext[];
  public formula(i: number): FormulaContext;
  public formula(i?: number): FormulaContext | FormulaContext[] {
  ...
  public AFTER(): TerminalNode | undefined {
    return this.tryGetToken(AntimonyParser.AFTER, 0);
  }
  constructor(parent: ParserRuleContext | undefined, invokingState: number) {
    super(parent, invokingState);
  }
  // @Override
  public get ruleIndex(): number {
    return AntimonyParser.RULE_event;
  }
  // @Override
  public enterRule(listener: AntimonyListener): void {
...
export class EventOptionsContext extends ParserRuleContext {
  ...
  // @Override
  public get ruleIndex(): number {
    return AntimonyParser.RULE_eventOptions;
  }
  // @Override
  public enterRule(listener: AntimonyListener): void {
...
export class EventOptionContext extends ParserRuleContext {
  ...
  // @Override
  public get ruleIndex(): number {
    return AntimonyParser.RULE_eventOption;
  }
  // @Override
  public enterRule(listener: AntimonyListener): void {
...
export class EventAssignmentsContext extends ParserRuleContext {
  ...
  public eventAssignment(
    i?: number,
  ): EventAssignmentContext | EventAssignmentContext[] {
    if (i === undefined) {
  ...
  // @Override
  public get ruleIndex(): number {
    return AntimonyParser.RULE_eventAssignments;
  }
  // @Override
  public enterRule(listener: AntimonyListener): void {
...
export class EventAssignmentContext extends ParserRuleContext {
  ...
  // @Override
  public get ruleIndex(): number {
    return AntimonyParser.RULE_eventAssignment;
  }
  // @Override
  public enterRule(listener: AntimonyListener): void {
...
export class AlgebraicRuleContext extends ParserRuleContext {
  ...
  // @Override
  public get ruleIndex(): number {
    return AntimonyParser.RULE_algebraicRule;
  }
  // @Override
  public enterRule(listener: AntimonyListener): void {
...
export class RenameContext extends ParserRuleContext {
  ...
  public IS(): TerminalNode {
    return this.getToken(AntimonyParser.IS, 0);
  }
  ...
  // @Override
  public get ruleIndex(): number {
    return AntimonyParser.RULE_rename;
  }
  // @Override
  public enterRule(listener: AntimonyListener): void {
...
export class ConversionFactorLeftContext extends ParserRuleContext {
  ...
  // @Override
  public get ruleIndex(): number {
    return AntimonyParser.RULE_conversionFactorLeft;
  }
  // @Override
  public enterRule(listener: AntimonyListener): void {
...
export class ConversionFactorRightContext extends ParserRuleContext {
  ...
  // @Override
  public get ruleIndex(): number {
    return AntimonyParser.RULE_conversionFactorRight;
  }
  // @Override
  public enterRule(listener: AntimonyListener): void {
...
export class DeleteContext extends ParserRuleContext {
  public DELETE(): TerminalNode {
    return this.getToken(AntimonyParser.DELETE, 0);
  }
  public variable(): VariableContext {
    return this.getRuleContext(0, VariableContext);
  }
  ...
  // @Override
  public get ruleIndex(): number {
    return AntimonyParser.RULE_delete;
  }
  // @Override
  public enterRule(listener: AntimonyListener): void {
...
export class AnnotationContext extends ParserRuleContext {
  ...
  // @Override
  public get ruleIndex(): number {
    return AntimonyParser.RULE_annotation;
  }
  // @Override
  public enterRule(listener: AntimonyListener): void {
...
export class VariableAnnotationContext extends ParserRuleContext {
  ...
  // @Override
  public get ruleIndex(): number {
    return AntimonyParser.RULE_variableAnnotation;
  }
  // @Override
  public enterRule(listener: AntimonyListener): void {
...
export class HasAnnotationContext extends ParserRuleContext {
  ...
  public HAS(): TerminalNode {
    return this.getToken(AntimonyParser.HAS, 0);
  }
  public unitFormula(): UnitFormulaContext {
  ...
  // @Override
  public get ruleIndex(): number {
    return AntimonyParser.RULE_hasAnnotation;
  }
  // @Override
  public enterRule(listener: AntimonyListener): void {
...
export class ModelAnnotationContext extends ParserRuleContext {
  ...
  public NAME(): TerminalNode | undefined {
    return this.tryGetToken(AntimonyParser.NAME, 0);
  }
  constructor(parent: ParserRuleContext | undefined, invokingState: number) {
    super(parent, invokingState);
  }
  // @Override
  public get ruleIndex(): number {
    return AntimonyParser.RULE_modelAnnotation;
  }
  // @Override
  public enterRule(listener: AntimonyListener): void {
...
export class AnnotationBodyContext extends ParserRuleContext {
  ...
  // @Override
  public get ruleIndex(): number {
    return AntimonyParser.RULE_annotationBody;
  }
  // @Override
  public enterRule(listener: AntimonyListener): void {
...
export class AnnotationItemContext extends ParserRuleContext {
  ...
  // @Override
  public get ruleIndex(): number {
    return AntimonyParser.RULE_annotationItem;
  }
...
export class StringContext extends ParserRuleContext {
  public STRING(): TerminalNode | undefined {
    return this.tryGetToken(AntimonyParser.STRING, 0);
  }
  public LONG_STRING(): TerminalNode | undefined {
    return this.tryGetToken(AntimonyParser.LONG_STRING, 0);
  }
  constructor(parent: ParserRuleContext | undefined, invokingState: number) {
    super(parent, invokingState);
  }
  // @Override
  public get ruleIndex(): number {
    return AntimonyParser.RULE_string;
  }
  // @Override
  public enterRule(listener: AntimonyListener): void {
...
export class UnitDeclarationContext extends ParserRuleContext {
  public UNIT(): TerminalNode {
    return this.getToken(AntimonyParser.UNIT, 0);
  }
  public NAME(): TerminalNode {
    return this.getToken(AntimonyParser.NAME, 0);
  }
  ...
  // @Override
  public get ruleIndex(): number {
    return AntimonyParser.RULE_unitDeclaration;
  }
  // @Override
  public enterRule(listener: AntimonyListener): void {
...
export class UnitFormulaContext extends ParserRuleContext {
  ...
  // @Override
  public get ruleIndex(): number {
    return AntimonyParser.RULE_unitFormula;
  }
...
export class InStatementContext extends ParserRuleContext {
  ...
  // @Override
  public get ruleIndex(): number {
    return AntimonyParser.RULE_inStatement;
  }
  // @Override
  public enterRule(listener: AntimonyListener): void {
...
export class ModelImportContext extends ParserRuleContext {
  ...
  public modelImportOption(
    i?: number,
  ): ModelImportOptionContext | ModelImportOptionContext[] {
    if (i === undefined) {
  ...
  // @Override
  public get ruleIndex(): number {
    return AntimonyParser.RULE_modelImport;
  }
  // @Override
  public enterRule(listener: AntimonyListener): void {
...
export class ModelImportOptionContext extends ParserRuleContext {
  ...
  // @Override
  public get ruleIndex(): number {
    return AntimonyParser.RULE_modelImportOption;
  }
  // @Override
  public enterRule(listener: AntimonyListener): void {
...
export class ModelImportValueContext extends ParserRuleContext {
  ...
  // @Override
  public get ruleIndex(): number {
    return AntimonyParser.RULE_modelImportValue;
  }
  // @Override
  public enterRule(listener: AntimonyListener): void {
